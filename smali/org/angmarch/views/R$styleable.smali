.class public final Lorg/angmarch/views/R$styleable;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lorg/angmarch/views/R$styleable;->ActionBar:[I
    ...
    sput-object v1, Lorg/angmarch/views/R$styleable;->ActionBarLayout:[I
    ...
    sput-object v1, Lorg/angmarch/views/R$styleable;->ActionMenuItemView:[I

    new-array v1, v3, [I

    sput-object v1, Lorg/angmarch/views/R$styleable;->ActionMenuView:[I
    ...
    sput-object v2, Lorg/angmarch/views/R$styleable;->ActionMode:[I
    ...
    sput-object v4, Lorg/angmarch/views/R$styleable;->ActivityChooserView:[I
    ...
    sput-object v5, Lorg/angmarch/views/R$styleable;->AlertDialog:[I

    new-array v5, v1, [I

    fill-array-data v5, :array_4

    sput-object v5, Lorg/angmarch/views/R$styleable;->AnimatedStateListDrawableCompat:[I

    new-array v5, v2, [I

    fill-array-data v5, :array_5

    sput-object v5, Lorg/angmarch/views/R$styleable;->AnimatedStateListDrawableItem:[I
    ...
    sput-object v6, Lorg/angmarch/views/R$styleable;->AnimatedStateListDrawableTransition:[I

    new-array v6, v5, [I

    fill-array-data v6, :array_7

    sput-object v6, Lorg/angmarch/views/R$styleable;->AppCompatImageView:[I

    new-array v6, v5, [I

    fill-array-data v6, :array_8

    sput-object v6, Lorg/angmarch/views/R$styleable;->AppCompatSeekBar:[I
    ...
    sput-object v7, Lorg/angmarch/views/R$styleable;->AppCompatTextHelper:[I
    ...
    sput-object v7, Lorg/angmarch/views/R$styleable;->AppCompatTextView:[I
    ...
    sput-object v7, Lorg/angmarch/views/R$styleable;->AppCompatTheme:[I
    ...
    sput-object v7, Lorg/angmarch/views/R$styleable;->ButtonBarLayout:[I
    ...
    sput-object v8, Lorg/angmarch/views/R$styleable;->ColorStateListItem:[I

    new-array v8, v5, [I

    fill-array-data v8, :array_d

    sput-object v8, Lorg/angmarch/views/R$styleable;->CompoundButton:[I

    new-array v8, v2, [I

    fill-array-data v8, :array_e

    sput-object v8, Lorg/angmarch/views/R$styleable;->CoordinatorLayout:[I

    new-array v6, v6, [I

    fill-array-data v6, :array_f

    sput-object v6, Lorg/angmarch/views/R$styleable;->CoordinatorLayout_Layout:[I

    new-array v6, v4, [I

    fill-array-data v6, :array_10

    sput-object v6, Lorg/angmarch/views/R$styleable;->DrawerArrowToggle:[I

    new-array v6, v1, [I

    fill-array-data v6, :array_11

    sput-object v6, Lorg/angmarch/views/R$styleable;->FontFamily:[I
    ...
    sput-object v6, Lorg/angmarch/views/R$styleable;->FontFamilyFont:[I
    ...
    sput-object v6, Lorg/angmarch/views/R$styleable;->GradientColor:[I

    new-array v6, v2, [I

    fill-array-data v6, :array_14

    sput-object v6, Lorg/angmarch/views/R$styleable;->GradientColorItem:[I
    ...
    sput-object v8, Lorg/angmarch/views/R$styleable;->LinearLayoutCompat:[I

    new-array v5, v5, [I

    fill-array-data v5, :array_16

    sput-object v5, Lorg/angmarch/views/R$styleable;->LinearLayoutCompat_Layout:[I

    new-array v5, v2, [I

    fill-array-data v5, :array_17

    sput-object v5, Lorg/angmarch/views/R$styleable;->ListPopupWindow:[I

    new-array v5, v1, [I

    fill-array-data v5, :array_18

    sput-object v5, Lorg/angmarch/views/R$styleable;->MenuGroup:[I
    ...
    sput-object v5, Lorg/angmarch/views/R$styleable;->MenuItem:[I

    new-array v5, v6, [I

    fill-array-data v5, :array_1a

    sput-object v5, Lorg/angmarch/views/R$styleable;->MenuView:[I

    new-array v4, v4, [I

    fill-array-data v4, :array_1b

    sput-object v4, Lorg/angmarch/views/R$styleable;->NiceSpinner:[I

    new-array v4, v7, [I

    fill-array-data v4, :array_1c

    sput-object v4, Lorg/angmarch/views/R$styleable;->PopupWindow:[I
    ...
    sput-object v4, Lorg/angmarch/views/R$styleable;->PopupWindowBackgroundState:[I

    new-array v2, v2, [I

    fill-array-data v2, :array_1d

    sput-object v2, Lorg/angmarch/views/R$styleable;->RecycleListView:[I
    ...
    sput-object v2, Lorg/angmarch/views/R$styleable;->SearchView:[I
    ...
    sput-object v4, Lorg/angmarch/views/R$styleable;->Spinner:[I

    new-array v1, v1, [I

    fill-array-data v1, :array_20

    sput-object v1, Lorg/angmarch/views/R$styleable;->StateListDrawable:[I
    ...
    sput-object v0, Lorg/angmarch/views/R$styleable;->StateListDrawableItem:[I
    ...
    sput-object v0, Lorg/angmarch/views/R$styleable;->SwitchCompat:[I
    ...
    sput-object v0, Lorg/angmarch/views/R$styleable;->TextAppearance:[I
    ...
    sput-object v0, Lorg/angmarch/views/R$styleable;->Toolbar:[I

    new-array v0, v2, [I

    fill-array-data v0, :array_24

    sput-object v0, Lorg/angmarch/views/R$styleable;->View:[I

    new-array v0, v7, [I

    fill-array-data v0, :array_25

    sput-object v0, Lorg/angmarch/views/R$styleable;->ViewBackgroundHelper:[I

    new-array v0, v7, [I

    fill-array-data v0, :array_26

    sput-object v0, Lorg/angmarch/views/R$styleable;->ViewStubCompat:[I
